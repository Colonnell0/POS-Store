 ...
 * @author Colonnello
 */
public class ProductsController extends Products_Model implements Initializable {
    ...
    public void supplierDetails(String supplierName) throws IOException {
        ...
        loader.setLocation(Main.class.getResource("/views/Supplier_Details.fxml"));
